...
if("-help" in args or "-h" in args):
    ...
    validSoftwares = ["helitronScanner", "ltrHarvest", "mitefind", "mitetracker", "must", "repeatmodel", "repMasker", "sinefind", "sinescan", "tirvish", "transposonPSI", "NCBICDD1000", "all", 'ltrRetriever']
    error = False
    if(not os.path.isdir(arg1) or arg1==""):
        print("ERROR: projectFolder ",arg1," doesnt exist!")
        error = True
    ...
    if(not error):
        ...
        createToolAnnotation_Files(os.path.join(arg1,arg2), os.path.join(arg1,arg2,"finalResults"), os.path.join(arg1,arg2,"parsedAnnotations"), os.path.join(arg1,arg2,"transposonCandB"), os.path.join(arg1,arg2,"transposonCandF")) # pipeline error
